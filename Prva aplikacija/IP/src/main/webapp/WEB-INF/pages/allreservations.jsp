...
<div class="container">
	...
	<div id="susscessDiv" class="alert alert-success"  style="display: none;">
   You reserved flight susscesfully
</div>
  
  <h3>Choose your flight</h1>
  ...
  <table class="table" >
    ...
    %>
      ...
      <tr id=<%= flight.getFlightId() %>>
        ...
        <td><button id=<%= flight.getFlightId() %> type="button" onclick="reservation(this.id)">Reserve</button></td>
      </tr>
