 ...
 <div class="table-responsive">          
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav" >
	 <li ><a href="http://localhost:8080/IP/?action=allFlightsArrivalsYesterday">Yesterday flights</a></li>
     <li ><a href="http://localhost:8080/IP/?action=allFlightsArrivalsToday">Today flights</a></li>
      <li><a href="http://localhost:8080/IP/?action=allFlightsArrivalsTommorow">Tommorow flights</a></li>
  </ul>
  </div>
</nav>
