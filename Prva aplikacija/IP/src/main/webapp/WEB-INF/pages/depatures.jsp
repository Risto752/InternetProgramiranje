...
<head>
  ...
  <script src="js/depatures.js"></script>
</head>
<body>
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
	 <li><a href="http://localhost:8080/IP/?action=allFlightsDepaturesYesterday">Yesterday flights</a></li>
     <li><a href="http://localhost:8080/IP/?action=allFlightsDepaturesToday">Today flights</a></li>
      <li><a href="http://localhost:8080/IP/?action=allFlightsDepaturesTommorow">Tommorow flights</a></li>
  </ul>
  </div>
</nav>
